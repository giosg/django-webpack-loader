...
* Merged forks https://github.com/owais/django-webpack-loader (Tag 0.7.0) and https://github.com/alihazemfarouk/django-webpack-loader (master)
* Fixed tests
* Removed deprecated configuration parameters: `BASE_ENTRYPOINT` and `EXCLUDE_RUNTIME`. These were not needed anymore.
* `render_entrypoint` is now basically same thing as `render_bundle` but it was kept for backwards compatibility.

* Tested to be compatible with following versions:
  * `webpack@^4.11.1`
